...
<body class="g-sidenav-show  bg-gray-200">
  ...
  @if(session('success'))
  <div id="alertDiv" class="alert alert-success mb-3" role="alert" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 9999;">
    <div class="alert alert-success alert-dismissible fade show" role="alert">
      {{ session('success') }}
      <button type="button" class="close" data-dismiss="alert" aria-label="Close" onclick="document.getElementById('alertDiv').style.display = 'none';">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
    <!-- Seu conteúdo da view -->
    <!-- Formulário de criação de memorandos, por exemplo -->
  </div>
      ...
      <div class="row">
        ...
        <form action="/memorando" role="form" method="POST">
          ...
          <div class="text-center">
            <input type="submit" value="Registrar" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0"></input>
          </div>
        </form>
